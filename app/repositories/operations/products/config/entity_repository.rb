class Operations::Products::Config::EntityRepository < Base
  ...
  def self.mapper
    "Operations::Products::Config::EntityMapper".constantize
  end
  ...
  PRODUCT_PATH = {
                "medclinic" => {"receivement" => "pj-medica", "practice" =>"pj-medica"},
