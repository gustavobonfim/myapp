class Financials::Balances::Statements::TransactionRepository < Base
  ...
  def self.entity
    "Financial::Balance::Statement::Transaction".constantize
  end

  def self.mapper
    "Financials::Balances::Statements::TransactionMapper".constantize
  end
