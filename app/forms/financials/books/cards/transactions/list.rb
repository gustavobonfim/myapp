class Financials::Books::Cards::Transactions::List
  ...
  def transactions
    ::Financials::Books::Cards::TransactionRepository.all_active
  end
  ...
  def data
    ...
    cln = ::Financials::Books::Cards::TransactionRepository.list(@transactions)
  ...
  def can_current_user_list_transaction?
    ::UserPolicies.new(@current_user_params[:current_user_id], "list", "financial_card_transactions").can_current_user?
  end
