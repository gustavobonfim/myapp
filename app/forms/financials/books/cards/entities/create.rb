class Financials::Books::Cards::Entities::Create
  ...
  def initialize(params)
    ...
    # return false unless @can_current_user_create_card
  ...
  def card
    ::Financials::Books::Cards::EntityRepository.build(@card_params)
  end
  ...
  def data
    # return cln = [] unless @can_current_user_create_card
    if @data
  ...
  def status
    # return :forbidden unless @can_current_user_create_card
    if @status
      return :created
    else
      return :bad_request
  ...
  def type
    # return "danger" unless @can_current_user_create_card
    if @type
      return "success"
    else
      return "danger"
  ...
  def can_current_user_create_card?
    ::UserPolicies.new(@current_user_params[:current_user_id], "create", "financial_card_entities").can_current_user?
  end
