class Financial::Book::Payable::Provider < ApplicationRecord
...
# Financial::Book::Payable::Provider.new(name: "Gustavo Bonfim", id_number: "07412332660", id_type: "individual")
