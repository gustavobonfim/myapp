class Financials::Books::Payables::ProviderRepository < Base
  ...
  def self.entity
    "Financial::Book::Payable::Provider".constantize
  end

  def self.mapper
    "Financials::Books::Payables::ProviderMapper".constantize
  end
