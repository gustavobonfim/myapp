class Financials::Books::Statements::TransactionRepository < Base
  ...
  def self.entity
    "Financial::Book::Statement::Transaction".constantize
  end

  def self.mapper
    "Financials::Books::Statements::TransactionMapper".constantize
  end
