class Commercial::Config::Date < ApplicationRecord

  self.table_name = "commercial_dates"
  
  # Relations
  has_one :calculation, class_name: "Commercial::Config::Calculation", foreign_key: "date_id", dependent: :destroy
