class Financials::Balances::Statements::Providers::Create
  ...
  def provider
    ::Financials::Balances::Statements::ProviderRepository.build(@provider_params)
  end
  ...
  def data
    ...
    if @data
      cln = ::Financials::Balances::Statements::ProviderRepository.read(@provider)
    else
      cln = []
    end
