class Financials::Books::Settings::ChartAccountRepository < Base
  ...
  ENUM_MASTER_NAME = {
                        ...
                        "client_reversal_payables"=>"Estornos a Fazer",
  ...
  ENUM_GROUP = {
                ...
                "asset_mutual_inside_group"=>"Mútuos no Grupo",
                "tangible"=>"Tangível",
                ...
                "refund_and_reversal_payables"=>"Reembolsos a Fazer",
                "advance_revenues"=>"Recebimentos Antecipados",
                "liability_mutual_inside_group"=>"Mútuos no Grupo",
                ...
                "technology_staff_expenses"=>"Despesas Com Pessoal Tecnologia",
  ...
  NUM_GROUP = {
                ...
                "refund_and_reversal_payables"=>"05",
                "advance_revenues"=>"06",
                "liability_mutual_inside_group"=>"07",
                ...
                "technology_staff_expenses"=>"01",
                "operation_staff_expenses"=>"02",
                "technology_expenses"=>"03",
                "services_expenses"=>"04",
