class Financials::Balances::Payables::Entities::List
  ...
  def payables
    ::Financials::Balances::Payables::EntityRepository.all_active
  end
  ...
  def data
    ...
    cln = ::Financials::Balances::Payables::EntityRepository.list(@payables)
