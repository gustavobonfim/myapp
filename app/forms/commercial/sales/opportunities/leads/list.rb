class Commercial::Sales::Opportunities::Leads::List
  ...
  def leads
    ::Commercial::Sales::Opportunities::LeadRepository.all_active
  end
  ...
  def data
    ...
    cln = ::Commercial::Sales::Opportunities::LeadRepository.list(@leads)
