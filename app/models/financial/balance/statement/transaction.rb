class Financial::Balance::Statement::Transaction < ApplicationRecord

  self.table_name = "financial_statement_transactions"
  ...
  belongs_to :from, class_name: "Financial::Balance::Setting::ChartAccount", foreign_key: "from_id"
  belongs_to :to, class_name: "Financial::Balance::Setting::ChartAccount", foreign_key: "to_id"
