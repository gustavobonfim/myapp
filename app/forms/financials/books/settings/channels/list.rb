class Financials::Books::Settings::Channels::List
  ...
  def channels
    ::Financials::Books::Settings::ChannelRepository.all_active
  end
  ...
  def data
    ...
    cln = ::Financials::Books::Settings::ChannelRepository.list(@channels)
