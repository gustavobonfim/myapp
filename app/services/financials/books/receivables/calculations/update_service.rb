class Financials::Books::Receivables::Calculations::UpdateService
  ...
  def update_calculation
    ...
    @calculation.total_addition_amount = @adjustments.select{|r| r.kind == "addition"}.map{|p| p.amount}.sum
    ...
    @calculation.total_invoice_amount = @calculation.total_income_amount - @calculation.total_discount_amount + @calculation.total_addition_amount
    @calculation.final_amount = @calculation.total_income_amount + @calculation.total_refund_amount + @calculation.total_addition_amount - @calculation.total_discount_amount - @calculation.total_reversal_amount - @calculation.total_error_amount
    ...
    @calculation.total_addition_received_amount = @adjustments.select{|a| a.status == "received" && a.kind == "addition"}.map{|a| a.amount}.sum
    ...
    @calculation.total_invoice_received_amount = @calculation.total_income_received_amount - @calculation.total_discount_received_amount + @calculation.total_addition_received_amount
    @calculation.total_received_amount = @calculation.total_income_received_amount + @calculation.total_refund_received_amount + @calculation.total_addition_received_amount - @calculation.total_discount_received_amount - @calculation.total_reversal_received_amount - @calculation.total_error_received_amount
