class Financials::Balances::Payables::Providers::List
  ...
  def providers
    ::Financials::Balances::Payables::ProviderRepository.all_active
  end
  ...
  def data
    ...
    cln = ::Financials::Balances::Payables::ProviderRepository.list(@providers)
