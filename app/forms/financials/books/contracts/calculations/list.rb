class Financials::Books::Contracts::Calculations::List
  ...
  def calculations
    ::Financials::Books::Contracts::CalculationRepository.all_active
  end
  ...
  def data
    ...
    cln = ::Financials::Books::Contracts::CalculationRepository.list(@calculations)
  ...
  def can_current_user_list_calculation?
    ::UserPolicies.new(@current_user_params[:current_user_id], "list", "financial_contract_calculations").can_current_user?
  end
