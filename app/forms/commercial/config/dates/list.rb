class Commercial::Config::Dates::List
  ...
  def dates
    ::Commercial::Config::DateRepository.all_active
  end
  ...
  def data
    ...
    cln = ::Commercial::Config::DateRepository.list(@dates)
  ...
  def can_current_user_list_date?
    ::UserPolicies.new(@current_user_params[:current_user_id], "list", "medbooking_dates").can_current_user?
  end
